'use client';
import { Box, Typography, Fade, useMediaQuery, useTheme, Drawer, IconButton } from '@mui/material';
...
export default function ATSPage() {
  ...
  return (
    <>
      ...
      <Box sx={{
        height: `calc(100vh - ${NAVBAR_HEIGHT}px)`, // ✅ prevents overflow
        width: '100vw',
        display: 'flex',
          ...
          {view === 'upload' ? (
            ...
            <Fade in timeout={400}>
              <Box sx={{ flex: 1, display: 'flex', overflow: 'hidden', width: '100%' }}>
                ...
                {isMobile && (
                  <>
                    <Box sx={{ flex: 1, overflowY: 'auto', background: '#0d0f17' }}>
                      <ParsedResumeView resume={resume} rawText={rawText} fileName={fileName} />
                    </Box>
