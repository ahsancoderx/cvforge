    ...
    <Box sx={{ minHeight: '100vh', background: '#0d0f14' }}>
      ...
      <Box sx={{
        ...
        <Box>
          ...
          <Typography sx={{ color: '#8b8fa8', fontSize: '0.9rem', mt: 0.5 }}>
      ...
      <Box sx={{
        ...
        >
          ...
          <Typography sx={{ color: '#8b8fa8', fontSize: '0.85rem' }}>
            Create New CV
          </Typography>
        </Box>
          ...
          >
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Box sx={{
                  height: 6,
                  background: tplColor[saved.template],
                  borderRadius: 1,
                  mb: '4px'
                }} />
            ...
            <Box sx={{
              ...
              <Typography sx={{ fontSize: '0.9rem', fontWeight: 600 }}>
                {saved.personal.name || 'Untitled'}
              </Typography>

              <Typography sx={{ fontSize: '0.78rem', color: '#8b8fa8' }}>
                {saved.personal.title || 'No title'}
              </Typography>

              <Box sx={{ display: 'flex', gap: 0.7, mt: 1 }}>
                <Chip
                  label={tplLabel[saved.template] || 'Minimal'}
                  size="small"
                  sx={{
                    fontSize: '0.7rem',
