  ...
  function handleDownload() {
    ...
    const r = {
      ...
      colorTheme:
        mode === 'bw'
          ? null
          : (theme !== undefined ? theme : resume.colorTheme),
    };
          ...
          {[
            {
              val: 'color',
              label: 'Full Color',
              sub: 'All template colors preserved',
              icon: <PaletteRoundedIcon sx={{ fontSize: 18, mb: 0.3 }} />
            },
            {
              val: 'bw',
              label: 'Black & White',
              sub: 'Classic monochrome',
              icon: <ContrastRoundedIcon sx={{ fontSize: 18, mb: 0.3 }} />
            },
          ].map(m => (
            <Box
              key={m.val}
            ...
            >
              ...
              <Typography sx={{ fontSize: '0.65rem', color: '#8b8fa8' }}>
                {m.sub}
              </Typography>
            </Box>
          ))}
